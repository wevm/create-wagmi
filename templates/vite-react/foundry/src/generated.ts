// Generated by @wagmi/cli@0.0.0-20230121004721 on 24/01/2023 at 7:19:41 am
import {
  useNetwork,
  useContract,
  UseContractConfig,
...
>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<
        ...
        'increment'
      > & { address?: never; chainId?: TChainId; functionName?: 'increment' }
...
>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<
        ...
        'setNumber'
      > & { address?: never; chainId?: TChainId; functionName?: 'setNumber' }
