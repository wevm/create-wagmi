...
If you want to contribute, but aren't sure where to start, you can create a [new discussion](https://github.com/wagmi-dev/create/discussions).
...
`create-wagmi` uses [pnpm](https://pnpm.io) as its package manager. You need to install **Node.js v16 or higher** and **pnpm v7 or higher**.
...
<div align="center">
  ✅ Now you're ready to contribute to `create-wagmi`! Follow the next steps if you need more advanced instructions.
</div>
